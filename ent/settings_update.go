...
func (_u *SettingsUpdate) ClearUpdateTime() *SettingsUpdate {
...
func (_u *SettingsUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.UpdateTimeCleared() {
		_spec.ClearField(settings.FieldUpdateTime, field.TypeTime)
	}
...
// ClearUpdateTime clears the value of the "update_time" field.
func (_u *SettingsUpdateOne) ClearUpdateTime() *SettingsUpdateOne {
	_u.mutation.ClearUpdateTime()
	return _u
}
