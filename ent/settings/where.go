...
func UpdateTimeIsNil() predicate.Settings {
	return predicate.Settings(sql.FieldIsNull(FieldUpdateTime))
}

// UpdateTimeNotNil applies the NotNil predicate on the "update_time" field.
func UpdateTimeNotNil() predicate.Settings {
	return predicate.Settings(sql.FieldNotNull(FieldUpdateTime))
}
